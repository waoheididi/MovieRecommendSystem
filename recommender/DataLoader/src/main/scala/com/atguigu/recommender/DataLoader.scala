...
object DataLoader {
  ...
  // 定义常量
  val MOVIE_DATA_PATH = "/root/start/data/movies.csv"
  val RATING_DATA_PATH = "/root/start/data/ratings.csv"
  val TAG_DATA_PATH = "/root/start/data/tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://192.168.88.107:27017/recommender",
      "mongo.db" -> "recommender",
      "es.httpHosts" -> "192.168.88.107:9200",
      "es.transportHosts" -> "192.168.88.107:9300",
