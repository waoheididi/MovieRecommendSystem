...
object ConnHelper extends Serializable{
  lazy val jedis = new Jedis("192.168.88.107")
  lazy val mongoClient = MongoClient( MongoClientURI("mongodb://192.168.88.107:27017/recommender") )
}
...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 定义kafka连接参数
    val kafkaParam = Map(
      "bootstrap.servers" -> "192.168.88.107:9092",
